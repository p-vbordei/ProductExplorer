...
from src.products_processing.products_firebase_utils import get_investigation_and_product_details, update_investigation_status
from src.products_processing.products_data_processing_utils import extract_brand_name, remove_brand
